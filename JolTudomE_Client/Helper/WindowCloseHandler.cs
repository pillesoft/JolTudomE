...
namespace JolTudomE_Client.Helper {
  public class WindowCloseHandler {
    ...
    public static DependencyProperty CloseCommandProperty = DependencyProperty.RegisterAttached("CloseCommand", typeof(ICommand), typeof(WindowCloseHandler), new PropertyMetadata(null, CloseCommandPropertyChangedCallback));

    /// <summary>
    /// Identifies the CloseFailCommand dependency property.
    /// </summary>
    //[SuppressMessage("Microsoft.StyleCop.CSharp.MaintainabilityRules", "SA1401:FieldsMustBePrivate", Justification = "Public field used for Depedency Property.")]
    public static DependencyProperty CloseFailCommandProperty = DependencyProperty.RegisterAttached("CloseFailCommand", typeof(ICommand), typeof(WindowCloseHandler), new PropertyMetadata(null));
